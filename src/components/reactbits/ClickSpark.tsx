...
/**
 * ClickSpark — adapted from React Bits (https://reactbits.dev)
 * Wraps children in a canvas overlay that draws a burst of sparks on click.
...
export function ClickSpark({
  ...
  return (
    <div className={className} style={{ position: "relative" }} onClickCapture={handleClick}>
      <canvas
        ref={canvasRef}
        style={{
          position: "absolute",
